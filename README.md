...
- **Lesing i to steg**: fyrst finn detektoren alle tekstfelta i biletet, uansett kva veg dei står. Så blir kvart felt retta opp til eit rektangel og lese for seg, både slik det ligg og opp ned, og den lesinga OCR-en er tryggast på vinn. Det er dette som gjer at eit løpenummer som står opp ned blir lese som `0004` og ikkje `7000`, og at me ikkje treng å gjette på kva veg motivet ligg. Deteksjonen går på halv oppløysing fordi ho er det dyraste steget og finn lappen like godt der, mens utsnitta blir klipte frå det store biletet slik at attkjenninga får dei skarpe pikslane.
- **Ekstra forsøk**: berre når fyrste lesinga ikkje gir ein heil ID med god skår, blir heile biletet snudd og prøvd på nytt (`--rotations`, standard `0,90,270,180`). Det er eit sikkerheitsnett for at *deteksjonen* kan gå glipp av ein lapp i éi stilling og finne han i ei anna, og det kostar berre tid på dei bileta som ikkje gav treff.
- **Val mellom fleire kandidatar**: same ID-en står ofte både handskriven i motivet og maskinskriven på ein lapp på tvers. Appen samlar alle kandidatane og vel mellom dei etter to reglar. Ein ID som står **heil i eitt tekstfelt** vinn alltid over ein som må settast saman av to felt, for då har OCR-en sjølv sett samanhengen. Skal to felt settast saman, må dei liggje **inntil kvarandre**, på same linje eller i same kolonne, målt mot tjukkleiken på teksten. Det er dette som skil løpenummeret på ein eigen klistrelapp frå datoen eller årstalet som står like ved. Blant like gode kandidatar vinn den med høgast OCR-skår. Skiljeteiknet kan vere punktum, komma eller bindestrek, og korkje `f`-en eller punktumet treng stå på lappen: dei lagar appen sjølv.
